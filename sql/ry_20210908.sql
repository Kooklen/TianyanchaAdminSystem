...
-- insert into sys_menu values('4', 'Datalink官网', '0', '4', '', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 Datalink新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 Datalink系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
