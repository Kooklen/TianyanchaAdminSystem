...
<!--      <el-table-column label="系统号" align="center" prop="id" />-->
      ...
      <el-table-column label="结束时间" align="center" prop="finaltime" width="180">
      </el-table-column>
      <el-table-column label="状态" align="center" prop="state" />
<!--      <el-table-column label="法人名" align="center" prop="legalpeople" />-->
...
<!--      <el-table-column label="处理时间" align="center" prop="finaltime" width="180">-->
<!--      </el-table-column>-->
...
<!--          <el-input v-model="form.state" placeholder="请输入状态" />-->
        ...
        <el-form-item label="统一社会信用代码" prop="code">
          <el-input v-model="form.code" placeholder="请输入统一社会信用代码"  :disabled="true"/>
        </el-form-item>
        <el-form-item label="联系方式" prop="contactphone">
    ...
    getList() {
      ...
      listWorkOrderManagement(this.queryParams).then(response => {
        ...
        if(response.rows[i].state == 1)
          {
            response.rows[i].state="已解决";
          }
        else
          {
            response.rows[i].state="无法解决";
